...
const FEATURES = [
  {
    ...
    items: [
      ...
      { name: "Goal Field", desc: "Set a one-liner at the top of each draft describing its purpose. Used as AI context." },
  ...
  },
  {
    category: "Press",
    items: [
      { name: "Pieces Space", desc: "Every idea gets a short-form feed alongside its long-form drafts. Toggle with Write | Pieces (⌘1 / ⌘2)." },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Download .md", desc: "Downloads a markdown file named after your draft." },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Reviewer's Side", desc: "The reviewer opens the file in a browser, highlights text to comment (or leaves a general comment), then hits Send back." },
      { name: "Import Review", desc: "Share → Import review loads the file the reviewer sent back and files its comments against this draft." },
